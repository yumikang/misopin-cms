        ...
        return (
          <div className="p-4 border rounded-lg bg-white">
            <div className="prose max-w-none">
              <div dangerouslySetInnerHTML={{ __html: 'text' in templateData.content ? templateData.content.text || '텍스트 콘텐츠' : '텍스트 콘텐츠' }} />
            </div>
          </div>
        );
        ...
        return (
          <div className="p-4 border rounded-lg bg-white">
            <div
              ...
              style={{
                gridTemplateColumns: `repeat(${'columns' in templateData.content ? templateData.content.columns || 3 : 3}, 1fr)`,
                gap: `${'gap' in templateData.content ? templateData.content.gap || 16 : 16}px`
              }}
            >
              {('items' in templateData.content && Array.isArray(templateData.content.items) ? templateData.content.items : [{}, {}, {}]).slice(0, 6).map((_, index: number) => (

...
interface BoardPostPaginationProps {
  pagination: {
    page: number;
    limit: number;
    total: number;
...
export function BoardPostPagination({ pagination }: BoardPostPaginationProps) {
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex items-center text-sm text-muted-foreground">
        총 {total}개의 게시글 중 {((page - 1) * pagination.limit) + 1}-{Math.min(page * pagination.limit, total)}번째 표시
      </div>

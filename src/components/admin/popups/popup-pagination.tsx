...
export function PopupPagination({ pagination }: PopupPaginationProps) {
  ...
  const createPageUrl = (pageNum: number) => {
    ...
    return `/admin/popups?${params.toString()}`;
  };
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex items-center text-sm text-muted-foreground">
        총 {total}개의 팝업 중 {((page - 1) * pagination.limit) + 1}-{Math.min(page * pagination.limit, total)}번째 표시
      </div>
